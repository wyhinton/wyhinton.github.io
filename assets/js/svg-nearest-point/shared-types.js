...
export async function loadSVGPaths(svgUrl) {
    try {
...
export function centerPathsInSVG(svg) {
        ...
        switch (upperCommand) {
            ...
            case 'T':
                ...
                for (let i = 0; i < numbers.length; i += 2) {
                    ...
                    modifiedNumbers.push((isRelative ? x : x + offsetX).toString(), (isRelative ? y : y + offsetY).toString());
                }
                break;
            case 'H':
            ...
            case 'C':
                ...
                for (let i = 0; i < numbers.length; i += 6) {
                    ...
                    modifiedNumbers.push((isRelative ? x1 : x1 + offsetX).toString(), (isRelative ? y1 : y1 + offsetY).toString(), (isRelative ? x2 : x2 + offsetX).toString(), (isRelative ? y2 : y2 + offsetY).toString(), (isRelative ? x : x + offsetX).toString(), (isRelative ? y : y + offsetY).toString());
                }
                break;
            case 'S':
            case 'Q':
                ...
                for (let i = 0; i < numbers.length; i += 4) {
                    ...
                    modifiedNumbers.push((isRelative ? x1 : x1 + offsetX).toString(), (isRelative ? y1 : y1 + offsetY).toString(), (isRelative ? x : x + offsetX).toString(), (isRelative ? y : y + offsetY).toString());
                }
                break;
            case 'A':
                ...
                for (let i = 0; i < numbers.length; i += 7) {
                    ...
                    modifiedNumbers.push(rx.toString(), ry.toString(), rotation.toString(), largeArc.toString(), sweep.toString(), (isRelative ? x : x + offsetX).toString(), (isRelative ? y : y + offsetY).toString());
                }
                break;
            default:
...
export function randomlyPlacePaths(svg, paths, padding = 20) {
    if (paths.length === 0)
        return paths;
    const svgRect = svg.getBoundingClientRect();
